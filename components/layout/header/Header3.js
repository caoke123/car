                            ...
                            <div className="col-lg-12">
                                <div className="header-style2 flex justify-space align-center">
                                    ...
                                    <div className="logo-box flex">
                                        <div className="logo"><Link href="/"><img src="/assets/images/logo/guotai.png" alt="Logo" /></Link></div>
                                    </div>
                ...
                <div className="mobile-menu">
                    ...
                    <nav className="menu-box">
                        <div className="nav-logo">
                            <Link href="/"><img src="/assets/images/logo/guotai.png" alt="Logo Motorx" /></Link>
                        </div>
