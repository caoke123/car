    ...
    return (
        <>
            <div className="tf-slide-form" style={{
                ...
                <div className="themesflat-container" style={{ position: 'relative', zIndex: 3 }}>
                    <div className="slide-form t-al-center">
                        <span className="wow fadeInUp" data-wow-delay="100ms" data-wow-duration="2000ms" style={{color: 'white'}}>Save up to <span className="text-red">15%</span></span>
                        <h1 className="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms" style={{color: 'white'}}>Find <span className="text-red">Perfect</span> Car. Let's Go!</h1>
