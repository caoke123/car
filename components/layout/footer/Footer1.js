                ...
                <div className="themesflat-container">
                    <div className="row footer-top">
                        <div className="col-lg-6 col-md-12 col-12 pd-r80 ">
                            <h2 className="title-footer-top">Your Professional <span className="red-title">Auto Export Partner</span><br/>We Handle Everything</h2>
                    ...
                    <div className="row footer-main">
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="widget widget-info">
                                <img src="/assets/images/logo/guotai.png" alt="Logo Footer" />
